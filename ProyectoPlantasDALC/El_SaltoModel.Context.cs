...
namespace ProyectoPlantasDALC
{
    ...
    public partial class ElSaltoEntities : DbContext
    {
        public ElSaltoEntities()
            : base("name=ElSaltoEntities")
        {
        }
        ...
        public virtual DbSet<VwGetLogin> VwGetLogin { get; set; }
